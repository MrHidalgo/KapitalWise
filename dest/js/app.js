 ...
 * ============================================= */
	var illustrationAnimation = function illustrationAnimation() {
		var mainAnimation = function mainAnimation() {
			...
			tl.to($('#main-box--left'), 0.4, { opacity: 1, ease: Power1.easeInOut }, '+=0.3').staggerTo($('#main__box-line > *'), 0.55, { scaleX: 1, ease: Power1.easeInOut }, 0.075, '-=0.2').staggerTo($('#main__box-graph > *'), 0.55, { scaleY: 1, ease: Power1.easeInOut }, 0.075, '-=0.3').staggerTo($('#main__box-point > *'), 0.55, { scale: 1, y: 0, ease: Power1.easeInOut }, 0.075, '-=0.3').staggerTo($('#main__sidebar-point > *'), 0.6, { scale: 1, ease: Power1.easeInOut }, 0.1, '-=1').staggerTo($('#main__sidebar-line > *'), 0.6, { scaleX: 1, ease: Power1.easeInOut }, 0.1, '-=1').staggerTo($('#main__content-line-1 > *'), 0.55, { scaleX: 1, ease: Power1.easeInOut }, 0.075, '-=0.75').staggerTo($('#main__content-line-2 > *'), 0.55, { scaleX: 1, ease: Power1.easeInOut }, 0.075, '-=0.75').staggerTo($('#main__content-line-3 > *'), 0.55, { scaleX: 1, ease: Power1.easeInOut }, 0.075, '-=0.75');
		};
